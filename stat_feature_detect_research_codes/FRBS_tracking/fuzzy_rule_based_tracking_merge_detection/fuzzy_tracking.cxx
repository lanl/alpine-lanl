...
int main(int argc, char** argv)
{
    ...
    // python env path set
    ///////////////////////////////////////////////////////////////////////////////
    setenv("PYTHONPATH","/home/soumya/Dropbox/Codes/fuzzy_rule_based_tracking_merge_detection/",1);
    Py_Initialize();
    ...
    //    //f2: for testing vortex t = 1 ~ 15 : mind = 0.25, split t = 11 3D MATCHING WORKS, PCA works (11,14) wrong split detection at t = 16 conf = 0.7, mass = 0.52 wroks fine
    //    xyzf[0] = 17.5;
    //    xyzf[1] = 67.5;
    //    xyzf[2] = 85.0;
    ...
    //    //merge test: merge at 18, track 10~20
    //    xyzf[0] = 25.5;
    //    xyzf[1] = 95.6;
    //    xyzf[2] = 76.5;
