...
int main(int argc, char** argv)
{
    ...
    ////Vortex data
    ////////////////////////////////////////////////////////////////////////
    path = "/Users/sdutta/Data/vortex_vti/";
    ...
    ///////////////////////////////////////////////////////////////////
    ifstream readoutFis;
    readoutFis.open("/Users/sdutta/Codes/fuzzy_rule_based_system/fuzzy_rule_based_training/outputParams.txt");
    ...
    //Read inmfs
    ifstream readinFis;
    readinFis.open("/Users/sdutta/Codes/fuzzy_rule_based_system/fuzzy_rule_based_training/inputParams.txt");
    ...
    for(int ii=initStep+1; ii<initStep+timeSteps;ii++)
    {
        ...
        cout<<"Matched feature at time: "<<ii<< " is: "<<match<< " distance changed: "<<distance_cog[match]<< " mass changed: "
           <<distance_mass[match]<<" cog changed: "<<distance_cbbox[match]<<" vol changed: "<<distance_blob[match]<<" FIS val: :"<<return_value.x<<endl;
