...
out_tracked_feature_cdb_path = '../out/feature_tracking_results/'
...
print ('tracking time:  ' + str(end_time-start_time) + ' secs.')
...
for i in range(np.shape(final_filtered_data)[0]):
    ...
    copy_command = 'cp ' + ffname + ' ' + out_tracked_feature_cdb_path 
