...
vtkSmartPointer<vtkImageData> readVtiRawData(string filename)
{
    /////////////////////////////////////////////////////////////////////
...
int main(int argc,char* argv[])
{
    ...
    string path = "/Users/sdutta/Codes/statistical_data_comparison/out/mfix_local_grid/";

    for (int tstep = 100; tstep<101;tstep++)
    {
        stringstream ss1;
        ss1<<tstep;
        string fname = path + "slic_compare_" + ss1.str() + ".vti";
    
        raw_data1 = readVtiRawData(fname);

        //int tstep = 250; //atoi(argv[2]);
        ...
        clkend = rtclock();
        cout<<"Slic is done for tstep: "<<tstep<<" and time taken: "<<clkend - clkbegin<<" secs"<<endl<<endl;
        ...
        // stringstream ss;
        // ss<<tstep;
        //string fname = "/disk2/Source_Codes/Statistical_data_comparison/out/slic_clusters/cluster_" + ss.str() + ".vti";
        fname = "cluster_" + ss1.str() + ".vti";
