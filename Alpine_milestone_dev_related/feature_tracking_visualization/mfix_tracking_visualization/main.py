...
class QVolumeViewer(QtWidgets.QFrame):
    ...
    def __init__(self, parent, lists, init_tstep):
        ...
        opacityTransferFunction2.AddPoint(0.000914029, 0.0435897)
        opacityTransferFunction2.AddPoint(0.107744, 0.279487)
        opacityTransferFunction2.AddPoint(0.9, 1.0)

        colorTransferFunction2 = vtk.vtkColorTransferFunction()
        colorTransferFunction2.AddRGBPoint(-0.9, 0.0, 0.0, 0.0)
        colorTransferFunction2.AddRGBPoint(-0.191293, 0, 0, 0.501961)
        colorTransferFunction2.AddRGBPoint(0.289984, 0.0, 0.501961, 1.0)
        colorTransferFunction2.AddRGBPoint(0.770721, 0.647059, 0.823529, 1)
        colorTransferFunction2.AddRGBPoint(0.89012, 0.905882, 0.952941, 1)
...
if __name__ == "__main__":
    ...
    src_path = '/Users/sdutta/Codes/tracking_interface/mfix_tracking_visualization/'
    sim_field_path = '/Users/sdutta/Codes/statistical_data_comparison/out/mfix_local_grid/'
    vel_field_path = '/Users/sdutta/Data/MFIX_bubble_fields_localbound_with_vel/'
    ...
    for file in sorted(os.listdir(path_to_all_features)):
        if file.endswith(".vti"):
            ...
            if int(tstep) < 100:
                vel_field_name = vel_field_path + 'fcc0' + str(int(tstep)*100) + '.vti'
            else:
                vel_field_name = vel_field_path + 'fcc' + str(int(tstep)*100) + '.vti'
