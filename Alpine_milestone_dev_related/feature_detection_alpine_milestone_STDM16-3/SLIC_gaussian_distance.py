...
def statistical_comparison(inparam):
    ...
    cluster_file = './out/cluster_files/cluster_' +  str(tstep) + '.vti'
    varname1 = 'ClusterIds'
...
##################################################################################################
feature_dist_input = '/Users/sdutta/Codes/statistical_data_comparison/feature_dists/new_bubble_local_grid_1.csv'
...
data_path = '/Users/sdutta/Codes/statistical_data_comparison/out/mfix_local_grid/' ## '/disk1/MFIX_bubble_fields_localbound/'
outpath = './out/' ## '../out/mfix_local_grid'
